                ...
                <table class="table table-bordered" id="" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo base_url('index.php/keuangan/bayar_hutang/') . $key['id_pembelian'] ?>"><button onclick="return confirm('Apakah Akan membayar Hutang ini?');" >Bayar</button></a>
                    <?php endforeach; ?>
                    </tr>
                  </tbody>
                </table>
